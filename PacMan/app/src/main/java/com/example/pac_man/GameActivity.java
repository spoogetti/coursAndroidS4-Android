...
public class GameActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    static final int G_INIT_SPEED = 500;
    ...
    private void launchMusic() {
        int chooseAtRandom = new Random().nextInt(musicList.length);


        mp=MediaPlayer.create(getApplicationContext(),musicList[chooseAtRandom]);
        mp.setLooping(true);
